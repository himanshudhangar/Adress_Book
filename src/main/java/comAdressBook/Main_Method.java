...
public class Main_Method {
	private static List<Adress_book> addressBooks = new LinkedList<Adress_book>();
	...
	private static void addressMenu(Adress_book addressBook) {
